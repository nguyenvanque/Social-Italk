...
public class AdapterChatGroup extends RecyclerView.Adapter<AdapterChatGroup.ViewHolder> {
    @NonNull
    ...
    public AdapterChatGroup(Context context, List<ModelGroupChat> modelGroupChatList) {
    ...
    @Override
    public void onBindViewHolder(@NonNull final AdapterChatGroup.ViewHolder holder, final int position) {
