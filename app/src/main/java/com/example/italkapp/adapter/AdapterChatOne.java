...
import com.example.italkapp.ChatOneActivity;
...
public class AdapterChatOne extends RecyclerView.Adapter<AdapterChatOne.MyHoler>  {
    ...
    public AdapterChatOne(Context context, List<ModelChat> chatList, String imageUrl) {
                    ...
                    if(ds.child("sender").getValue().equals(myUID)){
                        ...
                        ds.getRef().removeValue().addOnSuccessListener(new OnSuccessListener<Void>() {
                            ...
                            public void onSuccess(Void aVoid) {
                                ...
                                ChatOneActivity.adapterChat.notifyDataSetChanged();
                            }
                        });
                    }else {
