...
public class SettingGroupActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ColorStatusbar.setColorStatusBar(SettingGroupActivity.this);
        init();
        ...
        addMemberLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(SettingGroupActivity.this, GroupMemberAddActivity.class);
        ...
        viewMemberLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(SettingGroupActivity.this, ListMemberActivity.class);
                intent.putExtra("groupId", groupId);
                startActivity(intent);
            }
        });
        ...
        changeGroupNameLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(SettingGroupActivity.this,EditGroupActivity.class);
                intent.putExtra("groupId",groupId);
                startActivity(intent);
            }
        });
        ...
        ref.child(groupId).child("Participants").child(firebaseAuth.getUid())
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(SettingGroupActivity.this, R.string.Group_left_successfully, Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(SettingGroupActivity.this, HomeActivity.class));
                        finish();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(SettingGroupActivity.this, ""+e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
    ...
    private void deleteGroup() {
        ...
        ref.child(groupId)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(SettingGroupActivity.this, R.string.Group_deleted, Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(SettingGroupActivity.this, HomeActivity.class));
                        finish();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(SettingGroupActivity.this, getString(R.string.error), Toast.LENGTH_SHORT).show();
                    }
                });
    }
                ...
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        for (DataSnapshot ds : dataSnapshot.getChildren()) {
                            ...
                            try {
                                Picasso.with(SettingGroupActivity.this).load(groupIcon).placeholder(R.drawable.ic_app2).into(groupIconIv);
                            } catch (Exception e) {
